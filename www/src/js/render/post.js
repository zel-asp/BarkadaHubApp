export default function uploadedPost(name, content, file) {
    return `
       <div class="bg-white rounded-lg shadow-sm p-5 mb-6">
            <div class="flex justify-between items-center mb-4">
                <div class="flex items-center gap-3">
                    <div class="avatar w-10 h-10 rounded-full bg-gray-200 overflow-hidden">
                        <img src="https://i.pravatar.cc/150?img=1" alt="Developer Avatar"
                            class="w-full h-full object-cover">
                    </div>
                    <div>
                        <h4 class="font-medium">Developer Team</h4>
            ...
            <p>${content}</p>
            ${file ? `
            <div class="post-image mt-3 rounded-lg overflow-hidden h-64 w-full shadow-md">
                <img src="${file}" alt="Post Image" class="w-full h-full object-fit">
            </div>
            ` : ''}
